...
console.log(
  `Last car is ${inventory[lastCar].car_year} ${inventory[lastCar].car_make} ${inventory[lastCar].car_model}`
);
...
// ?     This takes the array of all years > Sorts them > Creates a Set which removes duplicates, then converts that Set back to an array
let sortedYears = Array.from(new Set(carYears.sort()));
